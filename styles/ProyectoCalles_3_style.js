var size = 0;
var placement = 'point';
function categories_ProyectoCalles_3(feature, value, size, resolution, labelText,
...
case 'Calle':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(247,251,255,0.0784313725490196)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3.8}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_ProyectoCalles_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_ProyectoCalles_3(feature, value, size, resolution, labelText,
