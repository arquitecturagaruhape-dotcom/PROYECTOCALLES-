var size = 0;
var placement = 'point';
function categories_ProyectoCalles_2(feature, value, size, resolution, labelText,
...
case 'Calle Nueva':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,214,7,1.0)', lineDash: null, lineCap: 'round', lineJoin: 'round', width: 3.8}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_ProyectoCalles_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_ProyectoCalles_2(feature, value, size, resolution, labelText,
